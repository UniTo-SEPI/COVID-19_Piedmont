...
const absolute_path_to_input_data = "C:\\fisici" #raw"C:\Progetti\True_input" # "/Users/pietro/GitHub/SEPI/Fake_input" 

# Path to folder that will contain intermediate outputs
# It must be absolute since these data cannot be part of the repository
const absolute_path_to_intermediate_output = ".\\Intermediate_output" #raw"C:\Progetti\Intermediate_Output" #raw"C:\Progetti\Fake_intermediate_output" 

# Absolute path to output folder
const absolute_path_to_output = ".\\Output" #".\\Output" 

# Absolute path to folder where to store output
const absolute_path_to_output_plots = ".\\Output_plots" #".\\Output_Plots" 
...
# [code for code in trasf_trasposti_15_19_df.DIA_PRIN if any(.![isdigit(c) for c in code])]

# all(.![isdigit(c) for c in "shw2jd"])
...
# with corrections w.r.t the above:
# "C00-C99", "D00-D48" -> "C00-D48" 
# "F00" -> "F01"
# "E14" -> "E13"
# "R573" -> "R578"
# "J820" -> "J82"
...
const ICD_9_CM_translations_orsi = Dict(
                                # Antencedents
                                "Neoplasms"                          => execute_applied_mapping(I10_I9_GEMs_dict, ["C00-D48"]),
                                ...
                                "Dementia"                           => execute_applied_mapping(I10_I9_GEMs_dict, ["F01-F03"]),
                                "Chronic ischemic heart disease" => execute_applied_mapping(I10_I9_GEMs_dict, ["I25"]),
                                "Diabetes mellitus" => execute_applied_mapping(I10_I9_GEMs_dict, ["E10-E13"]),
                                ...
                                "Shock" => execute_applied_mapping(I10_I9_GEMs_dict, ["R570-R571", "R578-R579"]),
                                "Renal failure, acute and unspecified" => execute_applied_mapping(I10_I9_GEMs_dict, ["N17", "N19"]),
                                "Other diseases of the respiratory system" => execute_applied_mapping(I10_I9_GEMs_dict, ["J00-J11", "J30-J39", "J60-J70", "J82-J848", "J85-J99"]),
                                ...
                                "Other infectious and parasitic diseases" => execute_applied_mapping(I10_I9_GEMs_dict, ["A00-A39", "A42-A99", "B00-B36", "B38-B48", "B50-B99"]),
                                "Other circulatory diseases" => execute_applied_mapping(I10_I9_GEMs_dict, ["I00-I09", "I95-I99"]),
                                ...
                                # Macro-aggregations
                                "antecendents" => execute_applied_mapping(I10_I9_GEMs_dict, ["C00-D48", "J40-J47", "I60-I66", "I670", "I672-I679", "I10-I13", "F01-F03", "I25", "E10-E13", "I48", "G30-G31", "N18"]),
                                "precipitating"=> execute_applied_mapping(I10_I9_GEMs_dict, ["I50-I51", "A40-A41", "B37", "B49", "B99", "R570-R571", "R578-R579", "N17", "N19", "J00-J11", "J30-J39", "J60-J70", "J82-J848", "J85-J99", "E86-E87", "I20-I24", "I26", "A00-A39", "A42-A99", "B00-B36", "B38-B48", "B50-B99", "I00-I09", "I95-I99","J81"]),
                                "complications" => execute_applied_mapping(I10_I9_GEMs_dict, ["J12-J18", "J849", "J960", "J969", "J80", "R04-R09", "R65" ]),

                                "Orsi" => execute_applied_mapping(I10_I9_GEMs_dict, ["C00-D48", "J40-J47", "I60-I66", "I670", "I672-I679", "I10-I13", "F01-F03", "I25", "E10-E13", "I48", "G30-G31", "N18", "I50-I51", "A40-A41", "B37", "B49", "B99", "R570-R571", "R578-R579", "N17", "N19", "J00-J11", "J30-J39", "J60-J70", "J82-J848", "J85-J99", "E86-E87", "I20-I24", "I26", "A00-A39", "A42-A99", "B00-B36", "B38-B48", "B50-B99", "I00-I09", "I95-I99","J81", "J12-J18", "J849", "J960", "J969", "J80", "R04-R09", "R65"]),
...
const with_quarantena_precauzionale = false
const with_inizio_sintomi           = false
for (run_name, with_riabilitativo) in reverse([("riabilitativo", true), ("without_riabilitativo", false)])
    ...
    #     ## trasf_trasposti
    #     CSV.write(joinpath(absolute_path_to_intermediate_output, run_name, "1-pre_processing/COVID-19/trasf_trasposti_processesd.csv"), trasf_trasposti_processed_df)
    # end
    ...
    if !skip_sdo_pre_processing
        ...
        trasf_trasposti_15_19_multiple_ricoveros_per_patient_processed = load_julia_variable(joinpath(absolute_path_to_intermediate_output, "with_riabilitativo", "1-pre_processing\\SDO\\skip_sdo_pre_processing\\trasf_trasposti_15_19_mul_ric_pat_proc"))

        ICD9CM_processedTrasfTraspostiOne_dct = load_julia_variable(joinpath(absolute_path_to_intermediate_output, "with_riabilitativo", "1-pre_processing\\SDO\\skip_sdo_pre_processing\\ICD9CM_processedTrasfTraspostiOne_dct"))

        ICD9CM_processed_joinAll_dct = load_julia_variable(joinpath(absolute_path_to_intermediate_output, "with_riabilitativo", "1-pre_processing\\SDO\\skip_sdo_pre_processing\\ICD9CM_processed_joinAll_dct"))

        ICD9CM_processedPositiviQuarantena_dct = load_julia_variable(joinpath(absolute_path_to_intermediate_output, "with_riabilitativo", "1-pre_processing\\SDO\\skip_sdo_pre_processing\\ICD9CM_processedPositiviQuarantena_dct"))
...
#     end
    ...
    if save
        ...
        if occursin("with_riabilitativo", run_name) # "riabilitativo_is_qp"

...
for (run_name, with_riabilitativo, with_inizio_sintomi) in [("riabilitativo_is",true, true), ("without_riabilitativo_is",false, true), ("riabilitativo_no_is",true, false), ("without_riabilitativo_no_is",false, false)]
    ...
    const run_name = "without_riabilitativo"
    ...
    ## COVID-19 data
    # include("./Code/Julia/processed_line_list.jl");
    const with_riabilitativo = false
